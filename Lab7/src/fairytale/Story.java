    ...
    public Story() {
        ...
        commandsManager.addCommand(//Добавление необходимых команд
                new Command("add", -1) {
                    @Override
                    public void execute() {
                        if(noises.addAll(Noise.fromJson(getArguments())))
                ...
                new Command("remove_greater", -1) {
                    @Override
                    public void execute(){
                        LinkedHashSet<Noise> args = Noise.fromJson(getArguments());
                ...
                new Command("save", 0) {
                    ...
                    public void execute() {
                        ...
                        commandsManager.println("Коллекция сохранена");
                    }
                    @Override
                    public void describe() {
                ...
                new Command("clear", 0) {
                    ...
                    public void execute() {
                        noises.clear();
                        commandsManager.println("Коллекция очищена");
                    }
                    @Override
                    public void describe() {
                ...
                new Command("remove", -1) {
                    @Override
                    public void execute() {
                        if(noises.removeAll(Noise.fromJson(getArguments())))
                ...
                new Command("add_if_max", -1) {
                    ...
                    public void execute() {
                        if (noises.size() > 0) {
                            ...
                            noises.addAll(
                            Noise.fromJson(getArguments()).stream()
                                    .filter(noise -> {
                        ...
                        }else noises.addAll(Noise.fromJson((getArguments())));
                    }
                    @Override
                    public void describe() {
